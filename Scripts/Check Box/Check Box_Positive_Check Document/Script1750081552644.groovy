...
WebUI.click(findTestObject('Check Box/Check Box_Check Box_Document'))
...
WebUI.verifyMatch(resultText, '.*documents.*workspace.*react.*angular.*veu.*office.*public.*private.*classified.*general.*', 
    true)
